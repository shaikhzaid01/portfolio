                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
                    ...
                    <div className="lg:col-span-6 xl:col-span-5 relative w-full max-w-md mx-auto lg:max-w-none">
                        ...
                        <div className="relative rounded-2xl border border-neutral-200/80 bg-white/60 p-6 shadow-2xl dark:border-neutral-800/80 dark:bg-neutral-900/50 backdrop-blur-md overflow-hidden">
                            ...
                            <div className="flex items-center justify-between border-b border-neutral-200/60 dark:border-neutral-800/60 pb-4 mb-4">
                                ...
                                <div className="flex gap-4">
                                    <button
                                        ...
                                        className={`text-xs font-mono px-2 py-0.5 rounded-sm transition-all duration-300 ${activeTab === 'metrics' ? 'bg-neutral-250 text-neutral-900 dark:bg-neutral-800 dark:text-neutral-100 font-medium' : 'text-neutral-400 dark:text-neutral-500 hover:text-neutral-600 dark:hover:text-neutral-300'}`}
                                    >
                                        Metrics
                                    </button>
                                    <button
                                        onClick={() => setActiveTab('queue')}
                                        className={`text-xs font-mono px-2 py-0.5 rounded-sm transition-all duration-300 ${activeTab === 'queue' ? 'bg-neutral-250 text-neutral-900 dark:bg-neutral-800 dark:text-neutral-100 font-medium' : 'text-neutral-400 dark:text-neutral-500 hover:text-neutral-600 dark:hover:text-neutral-300'}`}
                                    >
                                        Queue
                                    </button>
                                    <button
                                        onClick={() => setActiveTab('db')}
                                        className={`text-xs font-mono px-2 py-0.5 rounded-sm transition-all duration-300 ${activeTab === 'db' ? 'bg-neutral-250 text-neutral-900 dark:bg-neutral-800 dark:text-neutral-100 font-medium' : 'text-neutral-400 dark:text-neutral-500 hover:text-neutral-600 dark:hover:text-neutral-300'}`}
                                    >
                                        DB_Pool
                                    </button>
                                </div>
                            ...
                            {activeTab === 'metrics' && (
                                <div className="space-y-4 font-mono text-xs text-neutral-650 dark:text-neutral-400">
                                    ...
                                    <div className="space-y-2 border-t border-neutral-200/40 dark:border-neutral-800/40 pt-3">
                                    ...
                                    <div className="flex items-center justify-between border-t border-neutral-200/40 dark:border-neutral-800/40 pt-3">
                            ...
                            {/* Tab Content 2: Queue */}
                            {activeTab === 'queue' && (
                                <div className="space-y-3 font-mono text-xs text-neutral-650 dark:text-neutral-400">
                                    <div className="flex items-center justify-between">
                            ...
                            {activeTab === 'db' && (
                                <div className="space-y-3 font-mono text-xs text-neutral-655 dark:text-neutral-400">
                                    <div className="flex items-center justify-between">
